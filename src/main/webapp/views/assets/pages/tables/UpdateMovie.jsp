        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="${urlMovie}/update" class="nav-link  active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Chỉnh sửa</p>
                </a>
              </li>
                  ...
                  <c:forEach var="movie" items="${movies}">
                  	<tr>
						...
						<td class="text-center">
							<a href="${urlMovie}/update?mid=${movie.movieId}" style="color: white">
        ...
        <div class="row" style="justify-content: center">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="${urlMovie}/update" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="idmovie">Mã phim</label>
                    <input type="text" class="form-control" id="idmovie" name="movieId"  value="${movie.movieId}">
                    <span class="form-message">${emptyMovieId}</span>
                  </div>
                  <div class="form-group">
                    <label for="namemovie">Tên phim</label>
                    <input type="text" class="form-control" id="namemovie" name="title" value="${movie.title}">
                    <span class="form-message">${emptyTitle}</span>
                  </div>
                  <div class="form-group">
                    <label for="poster">Poster</label>
                    <input type="text" class="form-control" id="poster" name="poster" value="${movie.poster}">
                    <span class="form-message">${emptyPoster}</span>
                  </div>  
                  <div class="form-group">
                    <label for="codeembed">Đường dẫn trailer</label>
                    <input type="text" class="form-control" id="codeembed" name="linkEmbed" value="${movie.linkEmbed}" >
                    <span class="form-message">${emptyLinkEmbed}</span>
                  </div>  
                  <div class="form-group">
                    <label for="views">Lượt xem</label>
                    <input type="text" class="form-control" id="views" name="views" value="${movie.views}">
                    <span class="form-message"></span>
                  </div>  
                  <div class="form-group">
                    <label >Mô tả</label>
                    <textarea class="form-control"  row="3" name="description"> ${movie.description}</textarea>
                  </div>  
                  <div class="form-group">
                    <span style="color: #00c851">${isSuccess}</span>
                  </div> 
                  <button formaction="${urlMovie}/update" class="btn btn-danger">Chỉnh sửa</button>
                  <button formaction="${urlMovie}/delete" class="btn btn-danger">Xóa</button>
                </div>
               </form>
                <!-- /.card-body -->        
            <!-- /.card -->

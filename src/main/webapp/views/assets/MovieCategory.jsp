            ...
            <div class="row" style="padding-top: 100px">
              <div class="col-sm-12 overflow-hidden">
                <div class="iq-main-header d-flex align-items-center justify-content-between">
                  <h4 class="main-title">${category.nameCategory}</h4>
                </div>
        ...
        <div class="row">
        		<ul class="nav-page">
        			<c:forEach varStatus="i"  begin="1" end="${maxPage}">
        				<li class="nav-page-item ${i.index==currentPage ? 'page-active' : '' }">
        					<a href="${urlViewMovieByCategory}/${cid}?page=${i.index}">${i.index}</a>
        				</li>
        			</c:forEach>
        		</ul>
        </div>
